...
const ClaimNotFoundPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[calc(100vh-112px)] bg-RCColors-900 text-RCColors-200 px-4">
      <FiSearch className="text-primary w-16 h-16 mb-4" />
      <h1 className="text-2xl font-bold text-RCColors-100 mb-2">
        {t('noClaimsTitle')}
      </h1>
      <p className="text-RCColors-400 mb-6 text-center">
        {t('noClaimsDescription')}
      </p>
      <Link href="/pages/claims/create" passHref>
        <button
          type="button"
